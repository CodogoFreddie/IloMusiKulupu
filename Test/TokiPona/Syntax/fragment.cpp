...
TEST(Fragment, ConstExprConstructDifferentTrees)
{
    ...
    // static_assert( nimi_nimi_plus_nimi.getLhs().getLhs() == akesi, "not
    // constexpr");
    // static_assert( nimi_nimi_plus_nimi.getLhs().getRhs() == awen, "not
    // constexpr");
    // static_assert( nimi_nimi_plus_nimi.getRhs() == ante, "not constexpr");
    // static_assert( nimi_nimi_plus_nimi.getConj() == nullptr, "not
    // constexpr");

    // static_assert( nimi_plus_nimi_nimi.getLhs() == akesi, "not constexpr");
    // static_assert( nimi_plus_nimi_nimi.getRhs().getLhs() == awen, "not
    // constexpr");
    // static_assert( nimi_plus_nimi_nimi.getRhs().getRhs() == ante, "not
    // constexpr");
    // static_assert( nimi_plus_nimi_nimi.getConj() == nullptr, "not
    // constexpr");

    // static_assert( nimi_nimi_nimi.getLhs().getLhs() == akesi, "not
    // constexpr");
    // static_assert( nimi_nimi_nimi.getLhs().getRhs() == awen, "not
    // constexpr");
