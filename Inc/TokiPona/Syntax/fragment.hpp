...
class Fragment
{
  ...
  public:
    ...
    {
	return (lhs == rhs_frag.lhs) && (conjunctive == rhs_frag.conjunctive) &&
	       (rhs == rhs_frag.rhs);
    }

    template <typename LI_RHS>
    constexpr const Fragment<Fragment<LHS, RHS>, LI_RHS> li(LI_RHS rhs_) const
    {
	return Fragment<Fragment<LHS, RHS>, LI_RHS>(*this, rhs_);
    }
};
...
{
    return Fragment<const lang::Nimi &, const lang::Nimi &>(
	lhs, lang::dictionary::li_c, rhs);
}
